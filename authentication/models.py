...
class Profile(models.Model):
    ...
    country = models.CharField(max_length=150,default='Your Country')
    state = models.CharField(max_length=150,default='Your State')
    zip_code = models.CharField(max_length=150,default='Zip Code')
